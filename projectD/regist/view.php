        ...
        <!---->
         ...
         <div class="clear"></div><!-- 공백 -->
            ...
            <? if($image_name[0] != NULL ){ ?>
			                     ...
			                     <div class="col2"><a href="#" onclick="window.open('./data/<?=$image_copied[0]?>', '','scrollbars=no, toolbars=no,width=600,height=600')" border="0" ><img src="./data/<?=$image_copied[0] ?> " width="200" height="200"></a>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;</div> 
			
            <? } ?>
			<? if($image_name[1] != NULL ){ ?>
            
			                     <div class="col2"><a href="#" onclick="window.open('./data/<?=$image_copied[1]?>', '','scrollbars=no, toolbars=no,width=600,height=600')" border="0" ><img src="./data/<?=$image_copied[1] ?> " width="200" height="200"></a>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;</div> 
            <? } ?>
            <? if($image_name[2] != NULL){ ?>
           
			                     <div class="col2"><a href="#" onclick="window.open('./data/<?=$image_copied[2]?>', '','scrollbars=no, toolbars=no,width=600,height=600')" border="0" ><img src="./data/<?=$image_copied[2] ?> " width="200" height="200"></a>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;</div> 
