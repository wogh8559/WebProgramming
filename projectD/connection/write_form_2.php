...
<div id="wrapper">
  <div id="content" class = "container">
        ...
        <form  name="board_form" method="post" action="./insert_2.php?mode=modify&num=<?=$num?>&page=<?=$page?>&table=<?=$table?>" enctype="multipart/form-data"> 
        ...
        <!---->
         ...
         <div class="clear"></div><!-- 공백 -->
			<div class="write_line"></div>
              ...
              <div class="clear"></div><!-- 공백 -->
			<div id="write_info1"><div class="cl1"> 거래 현황 </div>
            <li2><select name="current" width="3px"> 
